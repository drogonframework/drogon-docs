...
**Note: Make sure your server firewall has allowed the 80 port. Otherwise, you won't see these pages. Another way is to change your port from 80 to 1024(or above) in case you got the error message below: **
```shell
